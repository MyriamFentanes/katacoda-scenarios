...
#ssh root@host01 'for i in {1..200}; do wget https://raw.githubusercontent.com/jboss-container-images/rhpam-7-openshift-image/7.0.x/templates/rhpam70-trial-ephemeral.yaml && break || sleep 2; done'

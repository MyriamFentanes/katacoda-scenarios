...
ssh root@host01 'for i in {1..200}; do oc new-app -e KIE_SERVER_URL=http://$(cat kie-server-url.txt) --template react-web-app -p SOURCE_REPOSITORY_URL=https://github.com/DuncanDoyle/rhpam7-workshop-reactjs-rules-client -n rhpam7-workshop && break || sleep 2; done'
